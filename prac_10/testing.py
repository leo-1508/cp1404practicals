...
def format_sentence(phrase):
    """
    Format a phrase as a sentence, capitalizing the first letter and ensuring it ends with a period.
...
def run_tests():
    ...
    test_car = Car()
    assert test_car.fuel == 0, "Car does not set fuel to default value correctly"
